...
#ones because we only want to play the chopping animation once 

# make sure because this wont work otherwise, go to "Chopping" under "StateMachine" and assign player 
